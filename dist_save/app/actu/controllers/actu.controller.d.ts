...
export declare class ActuController {
    ...
    constructor(realisationFileModel: RealisationFileModel, actuService: ActuService, agendaModel: AgendaModel, positionModel: PositionModel, realisationModel: RealisationModel, rendezVousModel: RendezVousModel, profileService: ProfileService, dbUsersService: Database.UsersService);
    ...
    shareActu(actuId: string): ShareLink;
}
