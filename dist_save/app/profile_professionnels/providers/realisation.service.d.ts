...
export declare class RealisationService {
    ...
    constructor(realisationModel: RealisationModel, realisationFileModel: RealisationFileModel, profileService: ProfileService, storageService: StorageService);
    create(dto: CreateRealisationDto, user_id: string): Promise<Realisation>;
