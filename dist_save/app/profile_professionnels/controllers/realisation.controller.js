...
let RealisationController = class RealisationController {
    ...
    async findUserRealisation(idUser, pagination) {
        ...
        return apiutils_1.PaginationResponseDto.responseDto(pagination, data, total).mapPromise((l) => dto_1.RealisationResponseDto.fromRealisation(l, this.realisationFileModel));
    }
...
exports.RealisationController = RealisationController = __decorate([
    ...
    __metadata("design:paramtypes", [Object, providers_1.RealisationService, Database.UsersService])
