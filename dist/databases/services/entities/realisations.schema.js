...
exports.RealisationVideosSchema = exports.REALISATION_VIDEO_MODEL_NAME = exports.RealisationFilesSchema = exports.REALISATION_FILE_MODEL_NAME = exports.RealisationsSchema = exports.REALISATION_MODEL_NAME = void 0;
...
], RealisationSchema.prototype, "isVideo", void 0);
__decorate([
...
exports.REALISATION_VIDEO_MODEL_NAME = 'realisation_video';
let RealisationVideoSchema = class RealisationVideoSchema extends base_schema_1.BaseSchema {
};
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: exports.REALISATION_MODEL_NAME }),
    __metadata("design:type", String)
], RealisationVideoSchema.prototype, "realisation_id", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], RealisationVideoSchema.prototype, "video_path", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], RealisationVideoSchema.prototype, "thumbnail", void 0);
RealisationVideoSchema = __decorate([
    (0, mongoose_1.Schema)({ collection: exports.REALISATION_VIDEO_MODEL_NAME })
], RealisationVideoSchema);
exports.RealisationVideosSchema = (0, base_functions_1.applySortedMongooseAdditionalFunctions)(mongoose_1.SchemaFactory.createForClass(RealisationVideoSchema));
