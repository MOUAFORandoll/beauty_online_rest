...
let ActuController = class ActuController {
    constructor(realisationFileModel, actuService, agendaModel, positionModel, realisationModel, realisationVideoModel, rendezVousModel, vueModel, shareModel, likeModel, profileService, configService) {
    ...
    async findAll(pagination, userId) {
        ...
        return apiutils_1.PaginationResponseDto.responseDto(pagination, data, total).mapPromise((l) => dto_1.ActuResponseDto.fromActu(l, userId, this.realisationFileModel, this.realisationVideoModel, this.agendaModel, this.positionModel, this.realisationModel, this.rendezVousModel, this.vueModel, this.shareModel, this.likeModel, this.profileService, this.configService));
    }
    async searchData(search, pagination, userId) {
        ...
        const results = await Promise.all(pageItems.map(async (item) => {
            if (item.type === 'actu') {
                const dto = await dto_1.ActuResponseDto.fromActu(item.data, userId, this.realisationFileModel, this.realisationVideoModel, this.agendaModel, this.positionModel, this.realisationModel, this.rendezVousModel, this.vueModel, this.shareModel, this.likeModel, this.profileService, this.configService);
                return {
                    type: 'actu',
                    title: dto.title,
    ...
    async findOneById(id, userId) {
        ...
        return dto_1.ActuResponseDto.fromActu(actu, userId, this.realisationFileModel, this.realisationVideoModel, this.agendaModel, this.positionModel, this.realisationModel, this.rendezVousModel, this.vueModel, this.shareModel, this.likeModel, this.profileService, this.configService);
    }
...
exports.ActuController = ActuController = __decorate([
    ...
    __param(5, (0, mongoose_1.InjectModel)(entities_1.REALISATION_VIDEO_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(6, (0, mongoose_1.InjectModel)(entities_1.RENDEZ_VOUS_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(7, (0, mongoose_1.InjectModel)(entities_1.VUE_REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(8, (0, mongoose_1.InjectModel)(entities_1.SHARE_REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(9, (0, mongoose_1.InjectModel)(entities_1.LIKE_REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __metadata("design:paramtypes", [Object, providers_1.ActuService, Object, Object, Object, Object, Object, Object, Object, Object, providers_2.ProfileService,
