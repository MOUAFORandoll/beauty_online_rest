...
class ActuResponseDto {
    static async fromActu(realisation, userId, realisationFileModel, realisationVideoModel, agendaModel, positionModel, realisationModel, rendezVousModel, vueModel, shareModel, likeModel, profileService, configService) {
        ...
        const formattedVideo = video
            ? {
                ...
                video_link: configService.get('APP_API_URL') + '/api/stream/' + video._id.toString(),
...
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Boolean)
], ActuResponseDto.prototype, "is_video", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Object)
], ActuResponseDto.prototype, "video", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", Number)
