...
const providers_1 = require("../../../common/modules/external/providers");
let RealisationService = class RealisationService {
    constructor(realisationModel, realisationFileModel, realisationVideoModel, profileService, storageService) {
    ...
    async createWithImages(dto, user_id) {
        ...
        try {
            ...
            for (const file of dto.files) {
                try {
                    ...
                    realisationFile.file_path = await this.storageService.uploadRealisationImage(file, realisationFile._id.toString());
    ...
    async createWithVideo(dto, user_id) {
        if (!dto.file) {
            throw new common_1.BadRequestException('At least one video is required');
        }
        const session = await this.realisationModel.db.startSession();
        session.startTransaction();
        try {
            ...
            try {
                ...
                const storedVideo = await this.storageService.processAndStoreVideoWithThumbnail(dto.file, realisationVideoFile._id.toString());
...
exports.RealisationService = RealisationService = __decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Object, profile_service_1.ProfileService,
