...
class RendezVousResponseDto {
    static async fromRendezVous(userModel, agendaModel, realisationModel, realisationFileModel, realisationVideoModel, creneauModel, profileModel, rendezVousModel, positionModel, rendezVous, configService) {
        ...
        const _realisation = await dto_2.RealisationResponseDto.fromRealisation(await realisationModel.findById(rendezVous.realisation_id), realisationFileModel, realisationVideoModel, configService);
