    ...
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: main_database_connection_1.REALISATION_VIDEO_MODEL_NAME, schema: main_database_connection_1.RealisationVideosSchema },
                ...
                { name: main_database_connection_1.VUE_REALISATION_MODEL_NAME, schema: main_database_connection_1.VueRealisationsSchema },
                { name: main_database_connection_1.SHARE_REALISATION_MODEL_NAME, schema: main_database_connection_1.ShareRealisationsSchema },
                { name: main_database_connection_1.LIKE_REALISATION_MODEL_NAME, schema: main_database_connection_1.LikeRealisationsSchema },
                { name: main_database_connection_1.NOTIFICATION_MODEL_NAME, schema: main_database_connection_1.NotificationsSchema },
