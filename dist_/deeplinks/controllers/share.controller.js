...
let ShareController = class ShareController {
    constructor(configService, profileService, realisationFileModel, realisationVideoModel, agendaModel, positionModel, realisationModel, rendezVousModel, vueModel, shareModel, likeModel, actuService) {
    ...
    async findOneActuById(id) {
        ...
        const actuFromDTP = actu_response_dto_1.ActuResponseDto.fromActu(actu, null, this.realisationFileModel, this.realisationVideoModel, this.agendaModel, this.positionModel, this.realisationModel, this.rendezVousModel, this.vueModel, this.shareModel, this.likeModel, this.profileService, this.configService);
        return this.fillTemplate({
            pageTitle: this.appName,
...
exports.ShareController = ShareController = __decorate([
    ...
    __param(3, (0, mongoose_1.InjectModel)(main_database_connection_1.REALISATION_VIDEO_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(4, (0, mongoose_1.InjectModel)(main_database_connection_1.AGENDA_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(5, (0, mongoose_1.InjectModel)(main_database_connection_1.POSITION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(6, (0, mongoose_1.InjectModel)(main_database_connection_1.REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(7, (0, mongoose_1.InjectModel)(main_database_connection_1.RENDEZ_VOUS_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(8, (0, mongoose_1.InjectModel)(main_database_connection_1.VUE_REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(9, (0, mongoose_1.InjectModel)(main_database_connection_1.SHARE_REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(10, (0, mongoose_1.InjectModel)(main_database_connection_1.LIKE_REALISATION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __metadata("design:paramtypes", [config_1.ConfigService,
        providers_1.ProfileService, Object, Object, Object, Object, Object, Object, Object, Object, Object, providers_2.ActuService])
], ShareController);
