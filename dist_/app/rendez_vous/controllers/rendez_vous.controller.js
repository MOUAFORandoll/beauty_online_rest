...
let RendezVousController = class RendezVousController {
    constructor(rendezVousService, userModel, agendaModel, realisationModel, realisationFileModel, creneauModel, profileModel, positionModel, rendezVousModel) {
    ...
    async create(userId, dto) {
        ...
        return await dto_1.RendezVousResponseDto.fromRendezVous(this.userModel, this.agendaModel, this.realisationModel, this.realisationFileModel, this.creneauModel, this.profileModel, this.rendezVousModel, this.positionModel, rendezVous);
    }
    async findUserRendezVous(userId, pagination) {
        ...
        return apiutils_1.PaginationResponseDto.responseDto(pagination, data, total).mapPromise((l) => dto_1.RendezVousResponseDto.fromRendezVous(this.userModel, this.agendaModel, this.realisationModel, this.realisationFileModel, this.creneauModel, this.profileModel, this.rendezVousModel, this.positionModel, l));
    }
    ...
    async acceptRdv(id) {
        ...
        return dto_1.RendezVousResponseDto.fromRendezVous(this.userModel, this.agendaModel, this.realisationModel, this.realisationFileModel, this.creneauModel, this.profileModel, this.rendezVousModel, this.positionModel, rendezVous);
    }
    async declineRdv(id) {
...
exports.RendezVousController = RendezVousController = __decorate([
    ...
    __param(5, (0, mongoose_1.InjectModel)(main_database_connection_1.CRENEAU_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(6, (0, mongoose_1.InjectModel)(main_database_connection_1.PROFILE_PRO_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(7, (0, mongoose_1.InjectModel)(main_database_connection_1.POSITION_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __param(8, (0, mongoose_1.InjectModel)(main_database_connection_1.RENDEZ_VOUS_MODEL_NAME, main_database_connection_1.DATABASE_CONNECTION)),
    __metadata("design:paramtypes", [providers_1.RendezVousService, Object, Object, Object, Object, Object, Object, Object, Object])
