...
exports.DeepLinksAppLauncher = void 0;
...
class DeepLinksAppLauncher {
    ...
    setupSwagger() {
        const apiUrl = this.configService.get('DEEPLINKS_URL');
    ...
    async launch() {
        const port = this.configService.get('DEEPLINKS_PORT');
        const appName = this.configService.get('DEEPLINKS_APP_NAME');
        await this.app.listen(port, () => {
            this.logger.log(`Server ${appName} started on port ${port}`);
        });
    }
}
exports.DeepLinksAppLauncher = DeepLinksAppLauncher;
//# sourceMappingURL=deeplinks.launcher.js.map